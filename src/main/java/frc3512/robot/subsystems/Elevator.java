...
public class Elevator extends SubsystemBase {
  private final CANSparkMax leftElevatorMotor =
      new CANSparkMax(
          Constants.ElevatorConstants.leftMotorID, CANSparkLowLevel.MotorType.kBrushless);
  private final CANSparkMax rightElevatorMotor =
      new CANSparkMax(
          Constants.ElevatorConstants.rightMotorID, CANSparkLowLevel.MotorType.kBrushless);
  private final MotorControllerGroup elevatorGroup =
      new MotorControllerGroup(leftElevatorMotor, rightElevatorMotor);
  private final SparkLimitSwitch limitSwitch =
      leftElevatorMotor.getReverseLimitSwitch(SparkLimitSwitch.Type.kNormallyOpen);
  ...
  public Command runElevator(DoubleSupplier elevator) {
    return run(
        () -> {
