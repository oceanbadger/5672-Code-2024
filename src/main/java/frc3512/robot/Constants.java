...
public final class Constants {
  ...
  //**Changed addresses of motors so they don't conflict */
  ...
  public static final class ElevatorConstants {
    ...
    public static final int rightMotorID = 38;
    public static final int encoderA = 25;
    public static final int encoderB = 26;
  ...
  public static final class ArmConstants {
    ...
    public static final int rightMotorID = 36;
